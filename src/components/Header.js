          ...
          <div className="row">
            <div className="col-6">
              <p className="text-white my-0">
                Free shipping over Rs.500 & Free returns
              </p>
            </div>
            <div className="col-6 text-white ">
              <p className="text-end my-0">
                service-mail{" "}
                <a className="text-white" href="service@buyit.ac.in">
                  service@buyit.ac.in
                </a>
              </p>
            </div>
      ...
      <header className="header-upper py-3">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-2">
              <h2>
                <Link className="text-white">BuyIt</Link>
              </h2>
            </div>
            <div className="col-5">
                ...
                <div>
                  <Link className="d-flex align-items-center gap-10 text-white">
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <p className="fonts-10 mb-0">Rs. 500</p>
                    </div>
                  </Link>
                </div>
              </div>
